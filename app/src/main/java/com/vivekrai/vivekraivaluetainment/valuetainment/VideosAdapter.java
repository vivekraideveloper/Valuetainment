...
public class VideosAdapter extends RecyclerView.Adapter<VideosAdapter.ImageViewHolder> {
    ...
    public VideosAdapter(Context context, List<Upload> list) {
    ...
    public ImageViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        return new VideosAdapter.ImageViewHolder(view);
    }
