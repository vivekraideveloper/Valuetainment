...
public class PostsFragment extends Fragment implements PostsAdapter.OnItemClickListener {
    PostsAdapter adapter;
    private RecyclerView recyclerView;
    private PostsAdapter imageAdapter;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        imageAdapter = new PostsAdapter(getActivity(), uploads);
